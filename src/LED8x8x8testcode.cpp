...
// void IRAM_ATTR onTimer(){//***MultiPlex BAM***MultiPlex BAM***MultiPlex BAM***MultiPlex BAM***MultiPlex BAM***MultiPlex BAM***MultiPlex BAM
// // Serial.println("MultiplexStart");
...
// // default timer value 80Mhz -> 250Khz divide by 
// My_timer = timerBegin(0, 320, true);
// timerAttachInterrupt(My_timer, &onTimer, true);
// timerAlarmWrite(My_timer, 35, true);
